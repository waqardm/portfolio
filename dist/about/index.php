    ...
    <main id="">
        ...
        <div class="about-info">
            ...
            <div class="bio">
                <h3 class="">BIO</h3>
                <p>
                    <span class="text-secondary">I'm a Javascript and Laravel focused developer currently seeking suitable roles.</span>
                ...
                <a href="../contact.html">contact me</a> if you feel we can work together. I've listed my focus areas below for <span class="text-secondary">fall/winter 2018</span>.</p>
            </div>
            <!-- <div class="focus">
            ...
            <div class="job job3">
                ...
                <p>Start blogging on basic subjects to solidify knowledge and increase exposure which will help with job search.</p>
            </div>
