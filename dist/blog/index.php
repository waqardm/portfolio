    ...
    <main id="">
        ...
        <div class="blog-info">
            ...
            <div class="post post-4">
                <img class="responsive" src="/img/blog/codingBytes4.png" alt="">
                <h2 class="post-title"><a href="/blog/coding-bytes-4">Coding Bytes: Part 4 — Conditional Statements</a></h2>
                <p>Date Published: 29 November, 2018</p>
                <p>Continuing with the Coding Bytes series, we take a look at conditional statements. Conditional statements are the base of most logic helping us move towards the fun stuff.</p>
                <ul>
